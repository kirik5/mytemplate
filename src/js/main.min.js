...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js_src/main.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./node_modules/dl-animate/dist/dl-animate-module.js":
/*!***********************************************************!*\
  !*** ./node_modules/dl-animate/dist/dl-animate-module.js ***!
  \***********************************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return DLAnimate; });\nclass DLAnimate{\r\n\tconstructor(){\r\n\t\tthis.raf = window.requestAnimationFrame || \r\n\t\t\t\t  window.webkitRequestAnimationFrame ||\r\n\t\t\t\t  window.msRequestAnimationFrame;\t\t  \r\n\r\n\t\tlet divTest = document.createElement(\"div\");\r\n\r\n\t\t/* checking browser for necessary opportunities */\r\n\t\tthis.canAnimate = (typeof this.raf === \"function\") &&\r\n\t\t\t\t\t  (\"classList\" in divTest) &&\r\n\t\t\t\t\t  typeof divTest.style.transition !== undefined;\r\n\r\n\t\tif(this.canAnimate){\r\n\t\t\tthis.raf = this.raf.bind(window);\r\n\t\t}\r\n\r\n\t\t/* requestAnimationFrame queue */\r\n\t\tthis.frames = [];\r\n\t\tthis.framesRun = false;\r\n\t}\r\n\r\n\tshow(el, options = {}){\r\n\t\tif(!this.canAnimate){\r\n\t\t\tthis._show(el);\r\n\t\t}\r\n\r\n\t\tif(!this._isHidden(el)){\r\n\t\t\treturn;\r\n\t\t}\r\n\r\n\t\t/* merge defaults and users options */\r\n\t\tlet settings = this._calcOptions(options);\r\n\r\n\t\t/* set handler on animation finish */\r\n\t\tthis._setFinishHandler(el, settings.track, settings.duration, () => {\r\n\t\t\tthis._removeClasses(el, settings.classNames.enterActive);\r\n\t\t\tthis._removeClasses(el, settings.classNames.enterTo);\r\n\t\t\tsettings.afterEnter(el);\r\n\t\t});\r\n\r\n\t\tthis._show(el);\r\n\t\tthis._addClasses(el, settings.classNames.enter);\r\n\t\tsettings.beforeEnter(el);\r\n\t\t\r\n\t\tthis._addFrame(() => {\r\n\t\t\tthis._addClasses(el, settings.classNames.enterActive);\r\n\t\t});\r\n\r\n\t\tthis._addFrame(() => {\r\n\t\t\tthis._removeClasses(el, settings.classNames.enter);\r\n\t\t\tthis._addClasses(el, settings.classNames.enterTo);\r\n\t\t});\r\n\t}\r\n\r\n\thide(el, options = {}){\r\n\t\tif(!this.canAnimate){\r\n\t\t\tthis._hide(el);\r\n\t\t}\r\n\r\n\t\tif(this._isHidden(el)){\r\n\t\t\treturn;\r\n\t\t}\r\n\r\n\t\tlet settings = this._calcOptions(options);\r\n\r\n\t\tthis._setFinishHandler(el, settings.track, settings.duration, () => {\r\n\t\t\tthis._hide(el);\r\n\t\t\tthis._removeClasses(el, settings.classNames.leaveActive);\r\n\t\t\tthis._removeClasses(el, settings.classNames.leaveTo);\r\n\t\t\toptions.systemOnEnd && options.systemOnEnd();\r\n\t\t\tsettings.afterLeave(el);\r\n\t\t});\r\n\r\n\t\tthis._addClasses(el, settings.classNames.leave);\r\n\t\t\r\n\t\tsettings.beforeLeave(el);\r\n\t\t\r\n\t\tthis._addFrame(() => {\r\n\t\t\tthis._addClasses(el, settings.classNames.leaveActive);\r\n\t\t});\r\n\r\n\t\tthis._addFrame(() => {\r\n\t\t\tthis._addClasses(el, settings.classNames.leaveTo);\r\n\t\t\tthis._removeClasses(el, settings.classNames.leave);\r\n\t\t});\r\n\t}\r\n\r\n\tinsert(target, el, options = {}, before = null){\r\n\t\tthis._hide(el);\r\n\t\ttarget.insertBefore(el, before);\r\n\t\tthis.show(el, options);\r\n\t}\r\n\r\n\tremove(el, options = {}){\r\n\t\toptions.systemDoneCallback = function(){\r\n\t\t\tel.parentNode.removeChild(el);\r\n\t\t}\r\n\r\n\t\tthis.hide(el, options);\r\n\t}\r\n\r\n\t_setFinishHandler(el, track, duration, fn){\r\n\t\tlet eventName;\r\n\t\tlet isCssTrack = true;\r\n\r\n\t\tif(track === 'transition'){\r\n\t\t\teventName = 'transitionend';\r\n\t\t}\r\n\t\telse if(track === 'animation'){\r\n\t\t\teventName = 'animationend';\r\n\t\t}\r\n\t\telse{\r\n\t\t\tisCssTrack = false;\r\n\t\t}\r\n\r\n\t\tif(isCssTrack){\r\n\t\t\tlet handler = function(){\r\n\t\t\t\tel.removeEventListener(eventName, handler);\r\n\t\t\t\tfn();\r\n\t\t\t};\r\n\r\n\t\t\tel.addEventListener(eventName, handler);\r\n\t\t}\r\n\t\telse{\r\n\t\t\tsetTimeout(fn, duration);\r\n\t\t}\r\n\t}\r\n\r\n\t_calcOptions(options){\r\n\t\tlet name = (options.name !== undefined) ? options.name : 'dl-nothing-doing-class';\r\n\t\tlet classNames = this._mergeSettings(this._classNames(name), options.classNames);\r\n\r\n\t\tdelete options.classNames;\r\n\r\n\t\tlet defaults = {\r\n\t\t\tname: '',\r\n\t\t\ttrack: 'transition',\r\n\t\t\tduration: null,\r\n\t\t\tclassNames: classNames,\r\n\t\t\tbeforeEnter(el){},\r\n\t\t\tafterEnter(el){},\r\n\t\t\tbeforeLeave(el){},\r\n\t\t\tafterLeave(el){},\r\n\t\t\tsystemDoneCallback(el){}\r\n\t\t}\r\n\r\n\t\tlet norm = this._mergeSettings(defaults, options);\r\n\r\n\t\t/* analize track & duration error */\r\n\r\n\t\treturn norm;\r\n\t}\r\n\r\n\t_classNames(name){\r\n\t\treturn {\r\n\t\t\tenter: name + '-enter',\r\n\t\t\tenterActive: name + '-enter-active',\r\n\t\t\tenterTo: name + '-enter-to',\r\n\t\t\tleave: name + '-leave',\r\n\t\t\tleaveActive: name + '-leave-active',\r\n\t\t\tleaveTo: name + '-leave-to'\r\n\t\t}\r\n\t}\r\n\r\n\t_addFrame(fn){\r\n\t\tthis.frames.push(fn);\r\n\r\n\t\tif(!this.framesRun){\r\n\t\t\tthis._nextFrame();\r\n\t\t}\r\n\t}\r\n\r\n\t_nextFrame(){\r\n\t\tif(this.frames.length === 0){\r\n\t\t\tthis.framesRun = false;\r\n\t\t\treturn;\r\n\t\t}\r\n\r\n\t\tlet frame = this.frames.shift();\r\n\r\n\t\tthis.raf(() => {\r\n\t\t\tthis.raf(() => {\r\n\t\t\t\tframe();\r\n\t\t\t\tthis._nextFrame();\r\n\t\t\t});\r\n\t\t});\r\n\t}\r\n\r\n\t_addClasses(el, str){\r\n\t\tlet arr = str.split(' ');\r\n\r\n\t\tfor(let i = 0; i < arr.length; i++){\r\n\t\t\tel.classList.add(arr[i]);\r\n\t\t}\r\n\t}\r\n\r\n\t_removeClasses(el, str){\r\n\t\tlet arr = str.split(' ');\r\n\r\n\t\tfor(let i = 0; i < arr.length; i++){\r\n\t\t\tel.classList.remove(arr[i]);\r\n\t\t}\r\n\t}\r\n\r\n\t_mergeSettings(defaults, extra){\r\n\t\tif(typeof extra !== \"object\"){\r\n\t\t\treturn defaults;\r\n\t\t}\r\n\r\n\t\tlet res = {};\r\n\r\n\t\tfor(let k in defaults){\r\n\t\t\tres[k] = (extra[k] !== undefined) ? extra[k] : defaults[k];\r\n\t\t}\r\n\t\t\r\n\t\treturn res;\r\n\t}\r\n\r\n\t_hide(el){\r\n\t\tel.style.display = 'none';\r\n\t}\r\n\r\n\t_show(el){\r\n\t\tel.style.removeProperty('display');\r\n\t\t\r\n\t\tif(this._isHidden(el)){\r\n\t\t\tel.style.display = 'block';\r\n\t\t}\r\n\t}\r\n\r\n\t_isHidden(el){\r\n\t\treturn this._getStyle(el, 'display') === 'none';\r\n\t}\r\n\r\n\t_getStyle(el, prop){\r\n\t\treturn getComputedStyle(el)[prop];\r\n\t}\r\n}//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./node_modules/dl-animate/dist/dl-animate-module.js\n");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery */ \"./node_modules/jquery/dist/jquery.js\");\n/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(jquery__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var dl_animate_dist_dl_animate_module__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! dl-animate/dist/dl-animate-module */ \"./node_modules/dl-animate/dist/dl-animate-module.js\");\n\n\nvar myAnimate = new dl_animate_dist_dl_animate_module__WEBPACK_IMPORTED_MODULE_1__[\"default\"](); // import slick from 'slick-carousel';\n// $('.your-class').slick();\n\njquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {\n  function change_mgrt() {\n    var w = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.first_offerimg img').css(\"width\");\n    var mr = -parseInt(w) / 2 + \"px\";\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.first_offerimg img').css(\"margin-right\", mr);\n  }\n\n  change_mgrt();\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).resize(function () {\n    change_mgrt();\n  });\n  var navMenu = document.querySelector('.nav');\n  var navBtn = document.querySelector('.navbutton');\n  var line01 = document.querySelector('.navbutton_line01');\n  var line02 = document.querySelector('.navbutton_line02');\n  var line03 = document.querySelector('.navbutton_line03');\n\n  function OffScroll() {\n    var winScrollTop = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop();\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).bind('scroll', function () {\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop(winScrollTop);\n    });\n  }\n\n  function showMenu() {\n    myAnimate.show(navMenu, {\n      name: 'menu'\n    });\n    navBtn.classList.add('navbutton-active');\n    line01.classList.add('navbutton_line01-active');\n    line02.classList.add('navbutton_line02-active');\n    line03.classList.add('navbutton_line03-active');\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.nav_overlay').css(\"display\", \"block\");\n    OffScroll();\n  }\n\n  function hideMenu() {\n    myAnimate.hide(navMenu, {\n      name: 'menu'\n    });\n    navBtn.classList.remove('navbutton-active');\n    line01.classList.remove('navbutton_line01-active');\n    line02.classList.remove('navbutton_line02-active');\n    line03.classList.remove('navbutton_line03-active');\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.nav_overlay').css(\"display\", \"none\");\n    jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).unbind('scroll');\n  }\n\n  navBtn.addEventListener('click', function () {\n    if (!navMenu.hasAttribute('style') || navMenu.style.display === 'none') {\n      showMenu();\n    } else {\n      hideMenu();\n    }\n  });\n  window.addEventListener('resize', function () {\n    if (document.documentElement.clientWidth >= 992) {\n      navMenu.removeAttribute('style');\n\n      if (navBtn.classList.contains('navbutton-active')) {\n        navBtn.classList.remove('navbutton-active');\n      }\n\n      if (line01.classList.contains('navbutton_line01-active')) {\n        line01.classList.remove('navbutton_line01-active');\n      }\n\n      if (line02.classList.contains('navbutton_line02-active')) {\n        line02.classList.remove('navbutton_line02-active');\n      }\n\n      if (line03.classList.contains('navbutton_line03-active')) {\n        line03.classList.remove('navbutton_line03-active');\n      }\n\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.nav_overlay').css(\"display\", \"none\");\n      jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).unbind('scroll');\n    }\n  });\n  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.nav_overlay').on('click', hideMenu);\n});//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///./src/js_src/main.js\n");
